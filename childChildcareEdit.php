...
<form method="POST" ACTION="childChildcare.php">
	<table>
		<tr><th><b>Update Child in Childcare</b></th><th>(Only fill in which need to be updated.)</th></tr>
		<tr>	
		...
		<tr>
			<td><label for="emem"><b>Teacher in Charge:</b></label></td>
			<td><?php
		...
		<tr>
			<td><input type="submit" value="Update" name="updatechildC"></td>
		</tr>
	</table>
</form>
